...
This Contribution License Agreement ("Agreement") is agreed to by the party signing below ("You"), and conveys certain license rights to the maintainer(s) of the [PROJECT] project ("Maintainer") for Your contributions to the project. This Agreement is effective as of the latest signature date below.  
